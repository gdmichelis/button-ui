...
function App() {
  return (
    <main className="buttons-container">
      <h1>Button UI Demo</h1>
      <div>
        <h2 className="buttons-heading">Small Buttons</h2>
        <div className="button-group">
          ...
          <Button $size="small" $variation="info">
            Buy Now!
          </Button>

          <Button $size="small" $variation="light">
            Buy Now!
          </Button>
      ...
      <div>
        <h2 className="buttons-heading">Medium Buttons</h2>
        <div className="button-group">
          ...
          <Button $size="medium" $variation="success">
            Buy Now!
          </Button>
          ...
          <Button $size="medium" $variation="warning">
            Buy Now!
          </Button>

          <Button $size="medium" $variation="info">
            Buy Now!
          </Button>

          <Button $size="medium" $variation="light">
            Buy Now!
          </Button>

          <Button $size="medium" $variation="dark">
            Buy Now!
          </Button>
        </div>
      </div>
      ...
      <div>
        <h2 className="buttons-heading">Large Buttons</h2>
        <div className="button-group">
          ...
          <Button $size="large" $variation="success">
            Buy Now!
          </Button>
          ...
          <Button $size="large" $variation="warning">
            Buy Now!
          </Button>

          <Button $size="large" $variation="info">
            Buy Now!
          </Button>

          <Button $size="large" $variation="light">
            Buy Now!
          </Button>

          <Button $size="large" $variation="dark">
            Buy Now!
          </Button>
        </div>
      </div>
      ...
      <div>
        <h2 className="buttons-heading">Outline Buttons</h2>
        <div className="button-group">
          <Button $size="small" $variation="primaryOutline">
            Buy Now!
          </Button>

          <Button $size="small" $variation="secondaryOutline">
            Buy Now!
          </Button>

          <Button $size="small" $variation="successOutline">
            Buy Now!
          </Button>

          <Button $size="small" $variation="dangerOutline">
            Buy Now!
          </Button>

          <Button $size="small" $variation="warningOutline">
            Buy Now!
          </Button>

          <Button $size="small" $variation="infoOutline">
            Buy Now!
          </Button>

          <Button $size="small" $variation="lightOutline">
            Buy Now!
          </Button>

          <Button $size="small" $variation="darkOutline">
            Buy Now!
          </Button>
        </div>
      </div>
      ...
      <div>
        <h2 className="buttons-heading">Full Width Button</h2>
      ...
      <div>
        <h2 className="buttons-heading">Button as Link</h2>
        <div className="button-group">
          <Button
            $size="medium"
            $color="blue"
      ...
      <div>
        <h2 className="buttons-heading">Custom Buttons</h2>
        <div className="button-group">
          <Button
            $background="#4CAF50"
            $color="#fff"
      ...
      <div>
        <h2 className="buttons-heading">Button with Icon</h2>
        <div className="button-group">
          <Button
            $variation="primary"
            $size="medium"
